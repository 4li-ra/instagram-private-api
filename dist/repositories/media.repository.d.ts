...
export declare class MediaRepository extends Repository {
  ...
  editMedia({ mediaId, captionText }: { mediaId: string; captionText: string }): Promise<MediaEditResponseRootObject>;
  delete({ mediaId, mediaType }: { mediaId: string; mediaType?: 'PHOTO' | 'VIDEO' | 'CAROUSEL' }): Promise<any>;
  private likeAction;
